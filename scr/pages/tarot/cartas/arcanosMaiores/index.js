...
export default function ArcanosMaiores() {
    ...
    return (
        <ScrollView>
            ...
            <Text style={styles.txtH1}>ArcanosMaiores</Text>
            <View>
                <Image style={styles.logo} source={require('../../../../../assets/linha.png')} />
            </View>
            <Text style={styles.txtH2} onPress={() => { navigation.navigate('Os Amantes')}}>Os Amantes</Text>
            ...
            <Text style={styles.txtH4} onPress={() => { navigation.navigate('Biblioteca')}}>3.2.1 Arcanos Maiores</Text>
